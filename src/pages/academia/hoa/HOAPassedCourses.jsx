...
const HOAPassedCourses = () => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            ...
            if (!event.target.closest('.learners-performance-period-menu') && !event.target.closest('.pc-btn-filters')) {
    ...
    // Mock Data based on the Passed Courses Image
    const passedCoursesData = [
        ...
        {
            id: 2,
            studentName: 'Nagy Tímea', location: 'Russia', flag: rwanda, // Mocking flag with rwanda for visual consistency if explicit is missing
            courseName: 'Javascript Fundamental Quiz',
        ...
        {
            id: 4,
            studentName: 'Halász Emese', location: 'Burundi', flag: rwanda,
            courseName: 'Javascript Fundamental Quiz',
            assessmentType: 'Summative Assessment', assessmentMeta: '23 Question',
        ...
        {
            id: 9,
            studentName: 'Virág Mercédesz', location: 'Mexico', flag: rwanda,
            courseName: 'Javascript Fundamental Quiz',
            assessmentType: 'Summative Assessment', assessmentMeta: '23 Question',
            attempts: '4', avgScore: '67.43', timeLimit: '90 Min'
        },
    ...
    const getSortedData = (data, config) => {
        ...
        return [...data].sort((a, b) => {
            ...
            // Handle dash/null logic for numeric columns
            ...
            <div className="hoa-passed-courses-page hoa-assignments-page hoa-reports-page">
                ...
                <div className="rep-table-wrapper">
                    <table className="rep-table">
                        ...
                        <tbody>
                            {getSortedData(passedCoursesData, sortConfig).map((row) => (
