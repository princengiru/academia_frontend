...
<body>
	<section class="left-col">
		<form class="signin-card" action="#" method="post" onsubmit="return false;">
			...
			<p class="signin-subtitle">Already have an Account? <a href="signin.php">Sign in</a></p>
			...
			<div class="field-group">
				...
				<div class="input-wrap">
					<input id="signupEmail" type="email" placeholder="email@email.com">
				</div>
			</div>
			...
			<div class="field-group">
				...
				<div class="input-wrap password">
					<input id="signupPassword" type="password" placeholder="Enter Password">
						<img src="../assets/icons/eye.svg" class="input-eye" alt="Toggle password visibility">
				</div>
			</div>
			...
			<div class="field-group">
				...
				<div class="input-wrap password">
					<input id="signupConfirm" type="password" placeholder="Re-enter Password">
						<img src="../assets/icons/eye.svg" class="input-eye" alt="Toggle password visibility">
				</div>
			</div>

			<label class="remember-row" for="signupTerms">
	...
	<section class="right-col">
		<img src="bg.png" alt="Signup visual" draggable="false">
	</section>
</body>
</html>
